...
## 🚀 배포 정보
* **Production URL:** https://lifeos-phi.vercel.app
* **Status:** ✅ 배포 완료 (2024-12-03)

## 1. 프로젝트 개요 (Overview)
* **프로젝트명:** 6-Month Muscle Reset
* **목표:** 인바디 기반 6개월 장기 컷팅 플랜의 진행 상황을 추적하고, 매일의 식단(단백질)과 운동 루틴을 체크하여 동기를 부여함.
* **타겟 디바이스:** 모바일 웹 (Mobile First) - ✅ PWA(Progressive Web App)로 홈 화면 추가 가능
...
## 2. 기술 스택 (Tech Stack)
* **Framework:** Next.js 16 (App Router 방식 사용) ✅
* **Language:** TypeScript ✅
...
* **Theme:** next-themes (Dark/Light 모드) ✅
...
* **오늘의 퀘스트 (Daily Quest):** ✅
    * [x] 물 3L 마시기 (Toggle) ✅
    * [x] 단백질 150g 채우기 (Progress Bar + 입력 모달 연동) ✅
    * [x] 야식 금지 / 클린식 (Toggle) ✅
* **오늘의 운동 (Today's Workout):** ✅
    * 요일별 자동 루틴 노출 (예: 월요일 -> 가슴/삼두) ✅
    * "운동 완료 인증" 버튼 (클릭 시 DB 저장 및 축하 효과) ✅
* **연속 달성 스트릭:** ✅ (NEW)
    * 모든 퀘스트 완료 시 스트릭 카운터 증가 ✅
    * 최장 스트릭 기록 표시 ✅
    * 7일 이상 연속 시 번개 아이콘 표시 ✅
* **다크/라이트 모드 토글:** ✅ (NEW)
...
* **캘린더 뷰:** ✅
    * 지난 날짜의 성공/실패 여부를 색상으로 표시 ✅

### C. 인바디 분석 (InBody) ✅ 완료
* **주간 인바디 스캔 업로드:** ✅
    * 1주일에 1회 인바디 측정 결과 이미지 업로드 ✅
    * 지원 형식: PNG, JPG, HEIC ✅
* **AI 이미지 분석 (Google Gemini Vision):** ✅
...
* **인바디 기반 맞춤 가이드:** ✅
    ...
    * 체지방률, 골격근량, 내장지방, BMI, 인바디점수 기반 맞춤 조언 ✅
    * 기초대사량 기반 칼로리/단백질 권장량 ✅

### E. 통계 (Stats) ✅ 완료
* **체중 변화 그래프:** 주간/월간/전체 체중 변화 추이 (Line Chart) ✅
* **습관 달성률:** 이번 주 퀘스트 성공률 표시 (물, 단백질, 클린식, 운동) ✅
* **인바디 지표 변화:** ✅
    * 골격근량, 체지방량 변화 추이 그래프 ✅
    * 인바디 점수 추이 그래프 ✅
...
### 디자인 원칙
* **Dark/Light Mode 지원**: 체중계/인바디 측정 시 보통 아침이므로 눈 피로도 감소 ✅
